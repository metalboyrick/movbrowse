    ...
    return (
      <Center width="100%" flexGrow={1} flexDirection={"column"} px={10}>
        <Text fontSize="5xl" as="b">
          Oh, Boy! Search and view your favorite movies here.
        </Text>
        <Text fontSize="4xl">
          From the classics to the contemporaries, we've got you covered! Golly!
        </Text>
      </Center>
    );
    ...
    <VStack width="100%" height="100%">
      ...
      <VStack mt={6}>
        ...
        {(data.length === 0 || error) && !loading && (
          <Center>Aw, Gee! Movie not found!</Center>
        )}
        {loading && (
          <Box my={4}>
            <Spinner color="teal" />
