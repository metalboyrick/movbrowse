...
jest.mock("@chakra-ui/react", () => {
    ...
    return {
        ...components,
        IconButton: jest.fn(({ onClick }) => <button onClick={onClick}>searchbutton</button>),
        Input: jest.fn(({ onChange, placeholder }) => <input onChange={onChange} placeholder={placeholder} />) 
      };
})
